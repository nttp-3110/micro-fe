(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("frint-react"), require("frint"), require("react"), require("rxjs/Observable"), require("frint-store"), require("rxjs/operator/map"), require("rxjs/operator/concatMap"), require("rxjs/operator/merge"), require("rxjs/operator/scan"), require("prop-types"), require("rxjs/operator/delay"), require("rxjs/operator/filter"));
	else if(typeof define === 'function' && define.amd)
		define(["frint-react", "frint", "react", "rxjs/Observable", "frint-store", "rxjs/operator/map", "rxjs/operator/concatMap", "rxjs/operator/merge", "rxjs/operator/scan", "prop-types", "rxjs/operator/delay", "rxjs/operator/filter"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("frint-react"), require("frint"), require("react"), require("rxjs/Observable"), require("frint-store"), require("rxjs/operator/map"), require("rxjs/operator/concatMap"), require("rxjs/operator/merge"), require("rxjs/operator/scan"), require("prop-types"), require("rxjs/operator/delay"), require("rxjs/operator/filter")) : factory(root["FrintReact"], root["Frint"], root["React"], root["Rx"], root["FrintStore"], root["Rx"]["Observable"]["prototype"], root["Rx"]["Observable"]["prototype"], root["Rx"]["Observable"]["prototype"], root["Rx"]["Observable"]["prototype"], root["PropTypes"], root["Rx"]["Observable"]["prototype"], root["Rx"]["Observable"]["prototype"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_6__, __WEBPACK_EXTERNAL_MODULE_18__, __WEBPACK_EXTERNAL_MODULE_19__, __WEBPACK_EXTERNAL_MODULE_20__, __WEBPACK_EXTERNAL_MODULE_21__, __WEBPACK_EXTERNAL_MODULE_26__, __WEBPACK_EXTERNAL_MODULE_27__) {
...
var _frintStore = __webpack_require__(5);
...
var _epics = __webpack_require__(24);
...
var _concatMap = __webpack_require__(18);
...
exports.default = (0, _frintReact.observe)(function (app) {
  ...
  var actions$ = _Observable.Observable.of({
    changeColor: function changeColor() {
      return store.dispatch(_actions.changeColor.apply(undefined, arguments));
    },
...
var _delay = __webpack_require__(26);
...
function colorEpic$(action$) {
  ...
  return (_context = (_context = _filter.filter.call(action$, function (action) {
    ...
    return (0, _actions.changeColor)(action.color);
  });
}
module.exports = exports['default'];
