(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("frint-react"), require("react"), require("frint"), require("rxjs/operator/map"), require("rxjs/operator/scan"));
	else if(typeof define === 'function' && define.amd)
		define(["frint-react", "react", "frint", "rxjs/operator/map", "rxjs/operator/scan"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("frint-react"), require("react"), require("frint"), require("rxjs/operator/map"), require("rxjs/operator/scan")) : factory(root["FrintReact"], root["React"], root["Frint"], root["Rx"]["Observable"]["prototype"], root["Rx"]["Observable"]["prototype"]);
  ...
  _createClass(Root, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        ' - ',
        this.props.text.split('').reverse().join('')
      );
    }
  }]);
...
exports.default = (0, _frintReact.observe)(function (app) {
  ...
  return (_context = _map.map.call(regionData$, function (data) {
    return {
      text: data.text
    };
  }), _scan.scan).call(_context, function (props, emitted) {
...
//# sourceMappingURL=app-reversed.js.map